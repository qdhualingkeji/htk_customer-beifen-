...
public class PermissionUtils {
    ...
    public static final int CODE_REAS_SMS_PERMISSION = 9;
    public static final int CODE_RECEIVE_SMS_PERMISSION = 10;
    ...
    public static final String PERMISSION_REAS_SMS = Manifest.permission.READ_SMS;
